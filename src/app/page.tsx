        ...
        <section id="hero" className="py-16 lg:py-24 text-center bg-gradient-to-br from-primary/10 via-background to-background">
          <div className="container max-w-screen-md">
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-8">
              Craft a standout resume that recruiters notice. AlignAI Resume Builder uses artificial intelligence to optimize, tailor, and generate professional resumes in minutes. Perfect for Indian jobseekers and freshers.
            </p>
        ...
        <section id="resume-builder" className="py-16 lg:py-24">
          <div className="container max-w-screen-xl">
             <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold mb-4">AI Resume Builder</h2>
